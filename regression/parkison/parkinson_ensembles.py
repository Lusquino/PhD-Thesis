        ...
        for learners in range (100, 1100, 100):
            ...
            for i in range(10):
                ...
                for m in means:
                    ...
                    saveToFile('housepriceBaggingRew.csv', [t, learners, m, np.mean(maetr), np.std(maetr), np.mean(maets), np.std(maets),np.mean(msetr), np.std(msetr), np.mean(msets), np.std(msets), np.mean(t1), np.std(t1), np.mean(t2), np.std(t2), np.mean(t3), np.std(t3)])

    resultsP = np.array(resultsP)
    resultsV = np.array(resultsV)
    resultsT = np.array(resultsT)

    saveToFile('housepriceBaggingRew.csv',[resultsP[np.argmin(resultsV[:,2])], resultsV[np.argmin(resultsV[:,2])], resultsT[np.argmin(resultsV[:,2])]])
    saveToFile('housepriceBaggingRew.csv',[resultsP[np.argmin(resultsV[:,6])], resultsV[np.argmin(resultsV[:,6])], resultsT[np.argmin(resultsV[:,6])]])
        ...
        for learners in range (100, 1100, 100):
            ...
            for i in range(10):
                ...
                for m in means:
                    ...
                    saveToFile('housepriceBoostRew.csv', [t, learners, m, np.mean(maetr), np.std(maetr), np.mean(maets), np.std(maets),np.mean(msetr), np.std(msetr), np.mean(msets), np.std(msets), np.mean(t1), np.std(t1), np.mean(t2), np.std(t2), np.mean(t3), np.std(t3)])

    resultsP = np.array(resultsP)
    resultsV = np.array(resultsV)
    resultsT = np.array(resultsT)

    saveToFile('housepriceBoostRew.csv',[resultsP[np.argmin(resultsV[:,2])], resultsV[np.argmin(resultsV[:,2])], resultsT[np.argmin(resultsV[:,2])]])
    saveToFile('housepriceBoostRew.csv',[resultsP[np.argmin(resultsV[:,6])], resultsV[np.argmin(resultsV[:,6])], resultsT[np.argmin(resultsV[:,6])]])
