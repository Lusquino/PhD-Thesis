    ...
    for t in range(5,31):
        ...
        for addr in possibleAddr[sTherm]:
            for m in means:
                ...
                for i in range(10):
                    print(i,m,addr,t)
                    rwsd = wsd.RegressionWisard(addressSize=addr, mean=m)
                    a = time.perf_counter()
                    rwsd.train(DS_train)
                    b = time.perf_counter()
                    delta1 = b - a
    ...
    for t in range(5,31):
        ...
        for addr in possibleAddr[sTherm]:
            for m in means:
                ...
                for i in range(1):
                    print(i,m,addr,t)
                    rwsd = wsd.RegressionWisard(addressSize=addr, mean=m, orderedMapping=True)
                    a = time.perf_counter()
                    rwsd.train(DS_train)
                    b = time.perf_counter()
                    delta1 = b - a
    ...
    for t in range(5,31):
        ...
        for addr in possibleAddr[sTherm]:
            for m in means:
                ...
                for i in range(10):
                    print(i,m,addr,t)
                    rwsd = wsd.ClusRegressionWisard(addressSize=addr, mean=m)
                    a = time.perf_counter()
                    rwsd.train(DS_train)
                    b = time.perf_counter()
                    delta1 = b - a
