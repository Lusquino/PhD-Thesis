...
ds_train = wp.DataSet("../../datasets/movielens/th_train.wpkds")
ds_test = wp.DataSet("../../datasets/movielens/th_test.wpkds")

writer = open("test_borda_test.txt", "w+")
