...
ds_train = wp.DataSet("../../datasets/cifar10/ot_train.wpkds")
ds_test = wp.DataSet("../../datasets/cifar10/ot_test.wpkds")
...
for address_size in range(18, 19):
    for discriminator_limit in range(3, 4):
        total_training_time = []
        total_test_time = []
        total_accuracy = []
        for i in range(3):
