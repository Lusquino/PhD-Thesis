...
ds_train = wp.DataSet("../../datasets/cifar10/lt_train.wpkds")
ds_test = wp.DataSet("../../datasets/cifar10/lt_test.wpkds")

writer = open("test_clus_lt_test.txt", "w+")
...
for address_size in range(14, 15):
    for discriminator_limit in range(5, 6):
        total_training_time = []
        total_test_time = []
        total_accuracy = []
        for i in range(3):
