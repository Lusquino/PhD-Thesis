...
ds_base = wp.DataSet("../../datasets/cifar10/mt_train.wpkds")
...
writer = open("test_boost_mt_test.txt", "w+")
...
for learners in range(10, 11):
    for models in ["heterogeneous"]:
        ...
        str(st.stdev(total_validation_time)) + "," + str(st.variance(total_validat'ion_time)) + "," +
