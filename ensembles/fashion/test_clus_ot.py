...
ds_train = wp.DataSet("../../datasets/fashion/ot_train.wpkds")
ds_test = wp.DataSet("../../datasets/fashion/ot_test.wpkds")

writer = open("test_clus_ot_test.txt", "w+")
...
for address_size in range(28, 29):
